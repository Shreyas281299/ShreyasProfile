...
const DRIVE_START_POSITION = new THREE.Vector2(- 8, 16)
...
export default class World
{
    ...
    setReveal()
    {
        ...
        this.reveal.go = () =>
        {
            ...
            this.physics.car.chassis.body.position.set(DRIVE_START_POSITION.x, DRIVE_START_POSITION.y, 12)
    ...
    {
        this.startingScreen = {}
        this.camera.target.set(DRIVE_START_POSITION.x, DRIVE_START_POSITION.y, 0)
        this.camera.targetEased.copy(this.camera.target)
        this.camera.pan.reset()

        // Area
        this.startingScreen.area = this.areas.add({
            position: DRIVE_START_POSITION,
            halfExtents: new THREE.Vector2(2.35, 1.5),
            hasKey: false,
            testCar: false,
            active: false
        })
        this.startingScreen.area.floorBorder.material.uniforms.uColor.value = new THREE.Color(0x3f93c5)
        this.startingScreen.area.floorBorder.material.uniforms.uAlpha.value = 0.85
        this.startingScreen.area.fence.material.uniforms.uBorderAlpha.value = 0.8
        ...
        this.startingScreen.loadingLabel.material = new THREE.MeshBasicMaterial({ transparent: true, depthWrite: false, color: 0x3f93c5, alphaMap: this.startingScreen.loadingLabel.texture })
        ...
        this.startingScreen.loadingLabel.mesh.position.set(DRIVE_START_POSITION.x, DRIVE_START_POSITION.y, 0)
        ...
        this.startingScreen.startLabel.material = new THREE.MeshBasicMaterial({ transparent: true, depthWrite: false, color: 0x3f93c5, alphaMap: this.startingScreen.startLabel.texture })
        ...
        this.startingScreen.startLabel.mesh.position.set(DRIVE_START_POSITION.x, DRIVE_START_POSITION.y, 0)
        ...
        this.resources.on('ready', () =>
        {
            window.requestAnimationFrame(() =>
            {
                ...
                gsap.to(this.startingScreen.area.floorBorder.material.uniforms.uAlpha, { value: 0.85, duration: 0.3 })
    ...
    setSections()
    {
        ...
        this.sections.portfolio = new PortfolioSection(options)
        this.container.add(this.sections.portfolio.container)
    }
