...
const AREA_ACCENT_COLOR = 0x3f93c5
...
export default class Area extends EventEmitter
{
    ...
    setFloorBorder()
    {
        ...
        this.floorBorder.material.uniforms.uColor.value = new THREE.Color(AREA_ACCENT_COLOR)
    ...
    setFence()
    {
        ...
        this.fence.material.uniforms.uColor.value = new THREE.Color(AREA_ACCENT_COLOR)
