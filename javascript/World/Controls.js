...
const iconDataUri = (_svg) => `data:image/svg+xml,${encodeURIComponent(_svg)}`
const mobileTriangle = iconDataUri('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><path fill="white" d="M32 8 56 52H8z"/></svg>')
const mobileDoubleTriangle = iconDataUri('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 64"><path fill="white" d="M28 8 52 52H4z"/><path fill="white" d="M52 8 76 52H28z"/></svg>')
const mobileCross = iconDataUri('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><path fill="white" d="m18 12 14 14 14-14 6 6-14 14 14 14-6 6-14-14-14 14-6-6 14-14-14-14z"/></svg>')
